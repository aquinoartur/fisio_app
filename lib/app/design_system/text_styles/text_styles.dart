...
class TextStyles {
  static final TextStyle title1 = GoogleFonts.nunito(
  ...
  static final TextStyle cardtitle2 = GoogleFonts.nunito(
    color: Colors.white,
    fontWeight: FontWeight.w600,
    fontSize: 14,
  );
  ...
  static final TextStyle ts2 = GoogleFonts.nunito(
      fontSize: 18,
      color: Colors.black.withOpacity(.7),
      fontWeight: FontWeight.w800);

  static final TextStyle ts3 = GoogleFonts.nunito(
      fontSize: 16,
      color: Colors.black.withOpacity(.7),
      fontWeight: FontWeight.w600);

  static final TextStyle ts4 =
...
///Font Roboto
// ignore: non_constant_identifier_names
var RobotoColoredStyle =
    GoogleFonts.roboto(color: FisioColorsPalette.primaryColor, fontSize: 14);

///Font Inter
// ignore: non_constant_identifier_names
var InterStyle = GoogleFonts.inter();

///Font DmSans
// ignore: non_constant_identifier_names
var DmSanStyle = GoogleFonts.dmSans();

///Font KalamStyle
// ignore: non_constant_identifier_names
var KalamStyle = GoogleFonts.kalam(
  fontSize: 36,
