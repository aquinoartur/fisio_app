...
ThemeData darkMode() {
  return ThemeData(
    ...
    hintColor: FisioColors.lowBlack,
    primaryColor: const Color.fromARGB(255, 74, 20, 140),
    ...
    inputDecorationTheme: InputDecorationTheme(
      hintStyle: GoogleFonts.nunito(color: FisioColors.lowBlack),
      labelStyle: GoogleFonts.nunito(color: FisioColors.lowBlack),
      floatingLabelStyle: GoogleFonts.nunito(color: FisioColors.lowBlack),
      disabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(30),
        borderSide: const BorderSide(
          color: Color.fromARGB(255, 74, 20, 140),
